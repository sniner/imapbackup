...
def parse_arguments():
    ...
    stats_parser = subparsers.add_parser(
        "stats", description="Show stats of email archive"
    )
    ...
    import_parser = subparsers.add_parser(
        "import", description="Import emails from source archive to destination"
    )
    ...
    addr_parser = subparsers.add_parser(
        "addresses", description="Show mail addresses of all emails in archive"
    )
    ...
    dbupd_parser = subparsers.add_parser(
        "db-from-archive", description="Update metadata database by reading all archive items"
    )
...
def run():
    ...
    log = setup_logger(
        ...
        loglevel=logging.DEBUG if args.verbose else logging.INFO if args.logfile else logging.WARNING
    )
